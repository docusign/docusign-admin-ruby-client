...
module DocuSign_Admin
  class IdentityProviderResponse
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'auto_provision_users')
        self.auto_provision_users = attributes[:'auto_provision_users']
      end
      ...
      if attributes.has_key?(:'saml_20')
        self.saml_20 = attributes[:'saml_20']
      end
    ...
    def hash
      [id, friendly_name, auto_provision_users, type, saml_20, links].hash
    end
