...
module DocuSign_Admin
  class DSGroupResponse
    attr_accessor :ds_group_id

    attr_accessor :account_id

    attr_accessor :source_product_name
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'ds_group_id')
        self.ds_group_id = attributes[:'ds_group_id']
      end
      ...
      if attributes.has_key?(:'source_product_name')
        self.source_product_name = attributes[:'source_product_name']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          source_product_name == o.source_product_name &&
          group_id == o.group_id &&
    ...
    def hash
      [ds_group_id, account_id, source_product_name, group_id, group_name, description, is_admin, last_modified_on, user_count, external_account_id, account_name].hash
    end
