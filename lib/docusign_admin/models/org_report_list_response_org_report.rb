...
module DocuSign_Admin
  class OrgReportListResponseOrgReport
    attr_accessor :complete

    attr_accessor :report_correlation_id
    ...
    attr_accessor :account_export_count
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'report_correlation_id')
        self.report_correlation_id = attributes[:'report_correlation_id']
      end
      ...
      if attributes.has_key?(:'account_export_count')
        self.account_export_count = attributes[:'account_export_count']
      end
      ...
      if attributes.has_key?(:'report_type_id')
        self.report_type_id = attributes[:'report_type_id']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          complete == o.complete &&
          report_correlation_id == o.report_correlation_id &&
          site_id == o.site_id &&
          report_id == o.report_id &&
          requestor == o.requestor &&
          created_on == o.created_on &&
          account_export_count == o.account_export_count &&
          url == o.url &&
    ...
    def hash
      [complete, report_correlation_id, site_id, report_id, requestor, created_on, account_export_count, url, report_type_id, report_date_range, custom_start_date, custom_end_date].hash
    end
