...
module DocuSign_Admin
  class UserProductProfileDeleteRequest
    ...
    def list_invalid_properties
      ...
      if @product_ids.nil?
        invalid_properties.push('invalid value for "product_ids", product_ids cannot be nil.')
      end
    ...
    def valid?
      return false if @product_ids.nil?
      true
    end
    ...
    def hash
      [user_email, user_id, product_ids].hash
    end
