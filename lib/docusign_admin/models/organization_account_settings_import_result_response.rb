...
module DocuSign_Admin
  class OrganizationAccountSettingsImportResultResponse
    attr_accessor :id
    ...
    attr_accessor :processing_issues_by_account
    ...
    def self.swagger_types
      {
        ...
        :'processing_issues_by_account' => :'Array<OASIRROrganizationAccountSettingsErrorDataResponse>',
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'processing_issues_by_account')
        if (value = attributes[:'processing_issues_by_account']).is_a?(Array)
          self.processing_issues_by_account = value
        end
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          processing_issues_by_account == o.processing_issues_by_account &&
    ...
    def hash
      [id, site_id, url, number_processed_accounts, error_details, processing_issues_by_account, number_unprocessed_accounts].hash
    end
