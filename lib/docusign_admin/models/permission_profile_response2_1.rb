...
module DocuSign_Admin
  class PermissionProfileResponse21
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'permission_profile_name')
        self.permission_profile_name = attributes[:'permission_profile_name']
      end
    end
    ...
    def hash
      [permission_profile_id, permission_profile_name].hash
    end
