...
module DocuSign_Admin
  class NewUserRequest
    ...
    def self.swagger_types
      {
        :'accounts' => :'Array<NewUserRequestAccountProperties>',
        :'user_name' => :'String',
        :'first_name' => :'String',
        :'last_name' => :'String',
        :'email' => :'String',
    ...
    def hash
      [accounts, user_name, first_name, last_name, email, default_account_id, language_culture, selected_languages, access_code, federated_status, auto_activate_memberships].hash
    end
