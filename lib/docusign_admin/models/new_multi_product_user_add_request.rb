...
module DocuSign_Admin
  class NewMultiProductUserAddRequest
    attr_accessor :product_permission_profiles
    ...
    attr_accessor :auto_activate_memberships
    ...
    def self.swagger_types
      {
        :'product_permission_profiles' => :'Array<ProductPermissionProfileRequest>',
        :'ds_groups' => :'Array<DSGroupRequest>',
        :'user_name' => :'String',
        :'first_name' => :'String',
        :'last_name' => :'String',
        :'email' => :'String',
        ...
        :'auto_activate_memberships' => :'BOOLEAN'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'product_permission_profiles')
        if (value = attributes[:'product_permission_profiles']).is_a?(Array)
          self.product_permission_profiles = value
        end
      end
      ...
      if attributes.has_key?(:'auto_activate_memberships')
        self.auto_activate_memberships = attributes[:'auto_activate_memberships']
      end
    end
    ...
    def list_invalid_properties
      ...
      if @product_permission_profiles.nil?
        invalid_properties.push('invalid value for "product_permission_profiles", product_permission_profiles cannot be nil.')
      end
    ...
    def valid?
      return false if @product_permission_profiles.nil?
    ...
    def ==(o)
      ...
      self.class == o.class &&
          product_permission_profiles == o.product_permission_profiles &&
    ...
    def hash
      [product_permission_profiles, ds_groups, user_name, first_name, last_name, email, default_account_id, language_culture, access_code, federated_status, auto_activate_memberships].hash
    end
